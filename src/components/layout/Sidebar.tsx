    ...
    >
      ...
      <div className="flex items-center gap-3 px-4 py-4 border-b border-white/10">
        ...
        <div className="min-w-0">
          <p className="text-white font-semibold text-sm truncate">{empresa || 'ERP Sistema'}</p>
          <p className="text-slate-500 text-xs truncate">{usuario}</p>
        </div>
      </div>
